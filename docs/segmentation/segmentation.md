...
I intentionally basically just clicked around the birds body at random to simulate the inaccuracy process.
...
auto result = Segmentation::region_growing_clustering(image, seeds, 0.3, 0.015);
```
